...
Push-Location $repoRoot
    try {
        ...
        "--exclude=orbslam/third_party/ORB_SLAM3_pybind/build",
        "--exclude=orbslam/third_party/ORB_SLAM3_pybind/evaluation",
        "--exclude=orbslam/third_party/ORB_SLAM3_pybind/Examples",
        "--exclude=orbslam/third_party/ORB_SLAM3_pybind/Examples_old",
